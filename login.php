...
<body>
	...
	<div class='container-fluid' >
		<div class='row'>
			<div class='col-md-3'> 
				<img src='images/QDME-AirFit.jpg' class='img-responsive' /> 
			...
			<div class='col-md-9'>
				<div class='content-area'> 
					...
					<div class='content-body'> 
						...
						<center><div class='badge-header'>Please select user type:</div></center> 
						<div class='row'>
							<div class='col-md-3'></div>
							<div class='col-md-8'> 
								<div class='row' style='margin-top: 70px;'> 
									<div class='col-md-4'>
										<center>
											<div class='img-login-icons'>
												<img  class='img-responsive' src='images/qdmelogo1.jpg' alt='login as a doctor' />
											</div>
									...
									<div class='col-md-8'> 
										...
										<center>
											...
											<center><a href='login.php?attempt=2'><div class='badge-header'>Provider</div></a></center> 
										</center>
									</div> 
