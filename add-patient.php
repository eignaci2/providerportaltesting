				...
				<div class='content-body'>
					<div class='form-holder' style='margin-top: 50px;'>
						...
						if(isset($_POST['p-name'])){
							$firstName = $_POST['p-firstName'];
							$lastName = $_POST['p-lastName'];
							...
							Patient::add($firstName, $lastName, $location, $age, $gender, $phone, $dateOfBirth, $diagnosis, $prescription, User::getToken(), $patientNumber, $condition); 
						}
						
						$form = new Form(3, "post");
						$form->init(); 
						$form->textBox("First Name", "p-firstName", "text",  "$firstName", ""); 
						$form->textBox("Last Name", "p-lastName", "text",  "$lastName", "");
